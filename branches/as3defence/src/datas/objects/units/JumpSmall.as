package datas.objects.units
{
	...
	public class JumpSmall implements IBzState
	{
		private	static const _SPEED				:Number = 0.04;
		private	static const HEIGHT_MAX			:Number = 0.4;
		...
		public function JumpSmall(path:Vector.<BzVoxel>, commander:BzStateMachine = null)
		{

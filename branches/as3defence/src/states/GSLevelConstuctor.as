package states
{
	...
	public class GSLevelConstuctor implements IBzState
	{
		public	static const NAME:String = "LEVEL_CONSTRUCTOR";
		...
		private	function onStateChange(event:FlexEvent):void
		{
			...
			_game.uic.addChild( DataCenter.getInstance().level.viewport );
			_game.getFSM().changeState( new GSLevelCondition() );
		}
